...
const Handpick = () => {
  return (
    <div>
        ...
        {/* <p className="text-2xl font-semibold my-5 font-serif pl-4">40$</p>
        <button className="text-white ml-4 bg-orange-600 p-3 rounded-3xl font-bold hover:bg-yellow-500">Add to cart</button> */}
        </div>
        ...
        {/* <p className="text-2xl font-semibold my-5 font-serif pl-4">90$</p>
        <button className="text-white ml-4 bg-orange-600 p-3 rounded-3xl font-bold hover:bg-yellow-500">Add to cart</button> */}
        </div>
        ...
        {/* <p className="text-2xl font-semibold my-5 font-serif pl-4">200$</p>
        <button className="text-white ml-4 bg-orange-600 p-3 rounded-3xl font-bold hover:bg-yellow-500">Add to cart</button> */}
        </div>
